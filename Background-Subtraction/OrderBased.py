    ...
    def detectBackground(self):
        ...
        for curr_frame_index in range(0, self.num_frames):
            for window_id in self.image_window_regions_dict.keys():
                ...
                curr_frame_ratio = roundFloatVal(numerator_sum_curr_frame / (denominator_sum_curr_frame + eps))
                last_frame_ratio = roundFloatVal(numerator_sum_last_frame / (denominator_sum_last_frame + eps))
